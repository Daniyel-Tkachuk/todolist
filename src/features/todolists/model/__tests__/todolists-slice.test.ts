...
test("correct todolist should be created", () => {
  ...
  const newTodolist = {id: "new_todolist_2026_06_20", title, addedDate: "", order: 0}

  const endState = todolistsReducer(startState, createTodolistTC.fulfilled({todolist: newTodolist}, "requestId", title))
